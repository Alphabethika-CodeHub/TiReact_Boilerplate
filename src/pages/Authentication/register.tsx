...
export const Register = () => {
    ...
    return (
        <>
            ...
            <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-soft-black lg:max-w-4xl border dark:border-0 dark:shadow-lg dark:shadow-elegant-soft-black">
